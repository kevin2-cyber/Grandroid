...
public final class GreeterGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.kimikevin.HelloRequest,
      com.kimikevin.HelloReply> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = com.kimikevin.HelloRequest.class,
      responseType = com.kimikevin.HelloReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.kimikevin.HelloRequest,
      com.kimikevin.HelloReply> getSayHelloMethod() {
    io.grpc.MethodDescriptor<com.kimikevin.HelloRequest, com.kimikevin.HelloReply> getSayHelloMethod;
    if ((getSayHelloMethod = GreeterGrpc.getSayHelloMethod) == null) {
      synchronized (GreeterGrpc.class) {
        if ((getSayHelloMethod = GreeterGrpc.getSayHelloMethod) == null) {
          GreeterGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<com.kimikevin.HelloRequest, com.kimikevin.HelloReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.kimikevin.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.kimikevin.HelloReply.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void sayHello(com.kimikevin.HelloRequest request,
        io.grpc.stub.StreamObserver<com.kimikevin.HelloReply> responseObserver) {
  ...
  public static final class GreeterStub
     ...
     * </pre>
     */
    public void sayHello(com.kimikevin.HelloRequest request,
        io.grpc.stub.StreamObserver<com.kimikevin.HelloReply> responseObserver) {
  ...
  public static final class GreeterBlockingStub
     ...
     * </pre>
     */
    public com.kimikevin.HelloReply sayHello(com.kimikevin.HelloRequest request) {
  ...
  public static final class GreeterFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.kimikevin.HelloReply> sayHello(
        com.kimikevin.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((com.kimikevin.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.kimikevin.HelloReply>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.kimikevin.HelloRequest,
              com.kimikevin.HelloReply>(
  ...
  private static abstract class GreeterBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.kimikevin.HelloWorldProto.getDescriptor();
    }
