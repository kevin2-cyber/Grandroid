...
public final class GreeterGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.kimikevin.grpc.HelloRequest,
      com.kimikevin.grpc.HelloReply> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = com.kimikevin.grpc.HelloRequest.class,
      responseType = com.kimikevin.grpc.HelloReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.kimikevin.grpc.HelloRequest,
      com.kimikevin.grpc.HelloReply> getSayHelloMethod() {
    io.grpc.MethodDescriptor<com.kimikevin.grpc.HelloRequest, com.kimikevin.grpc.HelloReply> getSayHelloMethod;
    if ((getSayHelloMethod = GreeterGrpc.getSayHelloMethod) == null) {
      synchronized (GreeterGrpc.class) {
        if ((getSayHelloMethod = GreeterGrpc.getSayHelloMethod) == null) {
          GreeterGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<com.kimikevin.grpc.HelloRequest, com.kimikevin.grpc.HelloReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.lite.ProtoLiteUtils.marshaller(
                  com.kimikevin.grpc.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.lite.ProtoLiteUtils.marshaller(
                  com.kimikevin.grpc.HelloReply.getDefaultInstance()))
              .build();
        }
      }
    }
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void sayHello(com.kimikevin.grpc.HelloRequest request,
        io.grpc.stub.StreamObserver<com.kimikevin.grpc.HelloReply> responseObserver) {
  ...
  public static final class GreeterStub
     ...
     * </pre>
     */
    public void sayHello(com.kimikevin.grpc.HelloRequest request,
        io.grpc.stub.StreamObserver<com.kimikevin.grpc.HelloReply> responseObserver) {
  ...
  public static final class GreeterBlockingStub
     ...
     * </pre>
     */
    public com.kimikevin.grpc.HelloReply sayHello(com.kimikevin.grpc.HelloRequest request) {
  ...
  public static final class GreeterFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.kimikevin.grpc.HelloReply> sayHello(
        com.kimikevin.grpc.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((com.kimikevin.grpc.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.kimikevin.grpc.HelloReply>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.kimikevin.grpc.HelloRequest,
              com.kimikevin.grpc.HelloReply>(
