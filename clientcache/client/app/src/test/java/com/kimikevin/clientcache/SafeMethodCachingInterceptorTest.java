...
public class SafeMethodCachingInterceptorTest {
    ...
    private final GreeterGrpc.GreeterImplBase greeterServiceImpl =
            new GreeterGrpc.GreeterImplBase() {
                ...
                public void sayHello(HelloRequest request, StreamObserver<HelloReply> responseObserver) {
                   HelloReply reply =
                           HelloReply.newBuilder().setMessage("Hello " + request.getName() + " " + count++).build();
                    responseObserver.onNext(reply);
                    responseObserver.onCompleted();
                }

                @Override
                public void sayAnotherHello(HelloRequest request, StreamObserver<HelloReply> responseObserver) {
                    HelloReply reply =
                            HelloReply.newBuilder()
                                    .setMessage("Hello again " + request.getName() + " " + count++)
                                    .build();
                    responseObserver.onNext(reply);
                    responseObserver.onCompleted();
                }
    ...
    private final AnotherGreeterGrpc.AnotherGreeterImplBase anotherGreeterServiceImpl =
            new AnotherGreeterGrpc.AnotherGreeterImplBase() {
                ...
                public void sayHello(HelloRequest request, StreamObserver<HelloReply> responseObserver) {
                    HelloReply reply =
                            HelloReply.newBuilder().setMessage("Hey " + request.getName() + " " + count++).build();
                    responseObserver.onNext(reply);
                    responseObserver.onCompleted();
                }
            };
    ...
    private final ServerInterceptor injectCacheControlInterceptor =
    ...
    public void setUp() {
        grpcServerRule
                .getServiceRegistry()
                .addService(ServerInterceptors.intercept(greeterServiceImpl, injectCacheControlInterceptor));
        ...
        HelloReply reply2 =
                ClientCalls.blockingUnaryCall(
                        ...
                        CallOptions.DEFAULT.withOption(
                                SafeMethodCachingInterceptor.NO_CACHE_CALL_OPTION,
                                true),
                        message
                );
        HelloReply reply3 =
    ...
    public void requestWithOnlyIfCachedOption_unavailableIfNotInCache() {
        try {
            ClientCalls.blockingUnaryCall(
                    ...
                    safeGreeterSayHelloMethod,
                    CallOptions.DEFAULT.withOption(
                            SafeMethodCachingInterceptor.ONLY_IF_CACHED_CALL_OPTION,
                            true),
                    message
            );
    ...
    @Test
    public void responseNoCacheDirective_notCached() {
    ...
    @Test
    public void responseNoStoreDirective_notCached() {
    ...
    @Test
    public void responseNoTransformDirective_notCached() {
    ...
    @Test
    public void responseMustRevalidateDirective_isIgnored() {
    ...
    @Test
    public void responseMaxAge_caseInsensitive() {
    ...
    @Test
    public void responseNoCache_caseInsensitive() {
        cacheControlDirectives.add("No-CaCHe");
    ...
    @Test
    public void combinedResponseCacheControlDirectives_parsesWithoutError() {
    ...
    @Test
    public void separateResponseCacheControlDirectives_parsesWithoutError() {
    ...
    @Test
    public void responseMaxAgeZero_notAddedToCache() {
        cacheControlDirectives.add("max-age=0");
    ...
    private static class TestCache implements SafeMethodCachingInterceptor.Cache {
        private final Map<SafeMethodCachingInterceptor.Key, SafeMethodCachingInterceptor.Value>
                internalCache =
                new HashMap<>();
        private final List<SafeMethodCachingInterceptor.Key> removedKeys =
                new ArrayList<>();
