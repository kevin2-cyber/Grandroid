...
set CLASSPATH=%APP_HOME%\lib\server-1.0-SNAPSHOT.jar;%APP_HOME%\lib\grpc-services-1.68.0.jar;%APP_HOME%\lib\grpc-protobuf-1.68.0.jar;%APP_HOME%\lib\grpc-stub-1.68.0.jar;%APP_HOME%\lib\protobuf-java-util-3.25.5.jar;%APP_HOME%\lib\grpc-netty-shaded-1.68.0.jar;%APP_HOME%\lib\grpc-protobuf-lite-1.68.0.jar;%APP_HOME%\lib\grpc-util-1.68.0.jar;%APP_HOME%\lib\grpc-core-1.68.0.jar;%APP_HOME%\lib\grpc-context-1.68.0.jar;%APP_HOME%\lib\grpc-api-1.68.0.jar;%APP_HOME%\lib\guava-33.2.1-jre.jar;%APP_HOME%\lib\jsr305-3.0.2.jar;%APP_HOME%\lib\proto-google-common-protos-2.41.0.jar;%APP_HOME%\lib\protobuf-java-3.25.5.jar;%APP_HOME%\lib\gson-2.11.0.jar;%APP_HOME%\lib\error_prone_annotations-2.28.0.jar;%APP_HOME%\lib\j2objc-annotations-2.8.jar;%APP_HOME%\lib\perfmark-api-0.27.0.jar;%APP_HOME%\lib\failureaccess-1.0.2.jar;%APP_HOME%\lib\listenablefuture-9999.0-empty-to-avoid-conflict-with-guava.jar;%APP_HOME%\lib\checker-qual-3.42.0.jar;%APP_HOME%\lib\annotations-4.1.1.4.jar;%APP_HOME%\lib\animal-sniffer-annotations-1.24.jar
